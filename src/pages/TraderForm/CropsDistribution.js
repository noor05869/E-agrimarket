              ...
              >
                {cropDistribution &&
                  cropDistribution.map((data, i) => (
                    <>
                      <Row> </Row>
                      <Row key={i} gutter={[24, 0]} justify="center">
                      ...
                      <Row justify="center" gutter={[24, 0]}>
                        ...
                        {i === cropDistribution.length - 1 ? (
                          <Col
                            className="icondiv justify-content-end p-0"
                            xs={23}
                            span={7}
                            sm={20}
                            md={14}
                    ...
                    <>
                      <Row justify="left" gutter={[24, 0]}>
                        ...
                        <Col xs={23} span={7} sm={20} md={7} className="p-0">
                          {i < 1 && (
                            <p className="mb-0" style={{ marginLeft: "13px" }}>
                              {" "}
                              <Label eLabel="Cattles " ulabel=" مویشی" />
                            </p>
                          )}
                          <Form.Item
                          ...
                          >
                            <Select
                              ...
                              name={`${i}cattle`}
                              defaultValue={
                                data.Cattles ? data.Cattles : undefined
                              }
                              onChange={(event) =>
